...
# Tool version: 2020.2
# Description: TCL script for re-creating Vivado project 'zybo_pcam5c'
#
...
if {$PRJ_TYPE == "DESIGN_PRJ_TYPE"} {
  ...
  add_files -fileset constrs_1 -norecurse $src_dir/constrs/debug.xdc
	...
	add_files -fileset constrs_1 -norecurse $src_dir/constrs/zybo_pcam5c.xdc
	set_property is_enabled true [get_files $src_dir/constrs/zybo_pcam5c.xdc]
...
# Add SoC wrapper sources files
	set vhdl_soc_file_list [findFiles ${PRJ_DIR}/../../../../../soc/hw/zybo_pcam5c_zynqps/src/hdl *.vhd]
