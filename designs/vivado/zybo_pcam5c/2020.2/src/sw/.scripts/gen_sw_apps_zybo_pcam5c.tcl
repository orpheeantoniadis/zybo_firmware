...
if {$tool_version >= "2019.2"} {
  ...
  set prj_platform "zybo_pcam5c"
  set prj_desc "Zynq platform project"
  set prj_xsa "${pwd}/../hw_export/zybo_pcam5c.xsa"
  ...
  set apu_0_app_sysprj "zybo_pcam5c_app_system"
  set apu_0_app_template "undefined"

  set apu_0_app_name "zybo_pcam5c_app"
  set apu_0_app_src_dir "${pwd}/../sw_apps/zybo_pcam5c_app/src"
  ...
  # Import source files
  sdk importsources -name $app_name -path ../sw_apps/zybo_pcam5c_app/src
