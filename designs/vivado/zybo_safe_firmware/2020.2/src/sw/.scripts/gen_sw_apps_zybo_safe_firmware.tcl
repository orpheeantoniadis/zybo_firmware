...
# Set variables
set pwd [pwd]
set tool_version "2020.2"

if {$tool_version >= "2019.2"} {
  set prj_workspace "../vitis_workspace"

  set prj_platform "zybo_safe_firmware"
  set prj_desc "Zynq platform project"
  set prj_xsa "${pwd}/../hw_export/zybo_safe_firmware.xsa"
  ...
  set apu_0_app_sysprj "zybo_safe_firmware_app_system"
  set apu_0_app_template "undefined"

  set apu_0_app_name "zybo_safe_firmware_app"
  set apu_0_app_src_dir "${pwd}/../sw_apps/zybo_safe_firmware_app/src"
  ...
  # Import source files
  sdk importsources -name $app_name -path ../sw_apps/zybo_safe_firmware_app/src
